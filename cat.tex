...
\begin{lemma}
\rm If $T$ is terminal object of $\cat{C}$, then there is only a identity in $\Hom(T,T)$.
\end{lemma}

\begin{lemma}
\rm If $\cat{C}$ has terminal object, then terminal objects are unique up to a unique isomophism.
\end{lemma}

\begin{proof}
假设有两个terminal objects $T_1$和$T_2$, 那么有两个unique morphism $t:T_1 \to T_2$和$r:T_2 \to T_1$，容易证明它们互为inverse，即$t$是一个isomorphism，同时这个isomorphism也是唯一存在的.   
\end{proof}
...
$$
% https://tikzcd.yichuanshen.de/#
\begin{tikzcd}
...
$$
% https://tikzcd.yichuanshen.de/#
\begin{tikzcd}
...
$$
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZABgBpiBdUkANwEMAbAVxiRAGEAKAQVO4EoQAX1LpMufIRQAmclVqMWbAGI9BIsdjwEiZafPrNWiDj1IANdaJAYtkorP3VDSk6svD5MKAHN4RUAAzACcIAFskMhAcCCQARmdFYxAAHRTGNAALOgB9bmFrEPDI6hikaQ0QIojEWWjYxABmSur40obmiiEgA
\begin{tikzcd}
...
$$
% https://tikzcd.yichuanshen.de/#
\begin{tikzcd}
...
$$
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZABgBpiBdUkANwEMAbAVxiRAGEAKAQVIA0AlCAC+pdJlz5CKAEzkqtRizYAxToJFiQGbHgJEyMhfWatEHHqQCaQ0eN1Sico9RPLzamyIUwoAc3giUAAzACcIAFskMhAcCCQARlclMxAAHTSABWxOOgEAfT5NEPCoxBi4pDlFUzY-fIAqYpAwyKrqSsQAZmTa8wzsrFyCqxBqBjoAIxgGTIk9aRBQrD8ACxxm1rKk2Pju3vcQNT9bCmEgA
\begin{tikzcd}
...
$$
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZABgBpiBdUkANwEMAbAVxiRAB12cYAPHYABIQAtgF8AFAGFxAQVIBaAJSkAYopCjS6TLnyEUZAExVajFm07c+gkROlylpAOLrN27HgJFD5E-
\begin{tikzcd}
...
\begin{itemize}
 	...
 	$$
 	% https://tikzcd.yichuanshen.de/#
\begin{tikzcd}
...
$$
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZABgBpiBdUkANwEMAbAVxiRAGEAKAIVO4EoQAX1LpMufIRQAmclVqMWbLgEE+gkWOx4CRACxzq9Zq0QgAYjw3yYUAObwioAGYAnCAFskZEDghIARiNFUxBnAD0AKmFRMPcvRCDff0RZBRM2AB1MxjQACzoAfW5hCiEgA
\begin{tikzcd}
