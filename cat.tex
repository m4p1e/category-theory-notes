...
\begin{definition}
\rm A monoid is a category with a single object. Given monoid $M$, we write $\cat{C}_{M}$ for the corresponding category with single object $\bullet$ and with $M$ as its hom-set. 
\end{definition}
